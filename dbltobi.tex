...
But when we come to talk about tricategories or locally cubical bicategories, \fxnote[author=LW]{In the introduction, these were called locally double bicategories. Should we make this consistent?}we have to restrict to pseudo natural transformations on the side of bicategories, since there is no tricategory (or locally cubical bicategory) containing arbitrary colax transformations: the interchange law only holds laxly.
...
\fxnote{Are you happy with this definition?}
...
\fxnote[author=LW]{For consistency, I have reformulated this first in terms of general V-enriched functors and then specialised to an lcbc-functor. Do you think this is a clear enough?}
