...
\begin{proof}
This follows from Proposition~\ref{thm:eqcomp} applied to the double category $\mathbb{E}q[\cat{B}]$, where \cat{B} is regarded as a double category with trivial tight 1-morphisms.
\end{proof}
...
This symmetric monoidal structure is observed in~\cite[Remark 17.17]{maysig:pht}, but without any details supplied.
