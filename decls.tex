%smbicat version
\usepackage{amsfonts,amsmath,stmaryrd,txfonts,mathrsfs,amsthm}
...
\newcommand{\doub}[1]{\ensuremath{\mathbb{#1}}}
...
\tikzstyle{doubleloose2}=[-implies, double equal sign distance, postaction={decorate},decoration={markings,mark=at position .5 with {\node at (0,-0.01) {$\bullet$};}}] % , mark=at position .93 with {\node at (0,-0.012) {$>$};}}]
...
\newcommand{\xlooseRightarrow}[1]{\mathrel{\overset{#1}{\raisebox{-.25em}{\usebox{\looseRightarrowbox}}}}}
