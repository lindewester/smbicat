...
\begin{rmk}
  ...
  In \cref{sec:1x1-to-bicat} we will need a further condition to ensure that the ``componentwise'' companion of a tight transformation is pseudo, rather than lax or colax, natural.
\end{rmk}
