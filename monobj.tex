...
The 1-cell $f:A \onecell B$ is {\bf oplax monoidal} when it is equipped with loose 2-cells $\bar{\xi}$ and $\bar{\iota}$ which go in the opposite direction of $\chi$ and $\iota$, respectively, and with the following globular 3-cells: 
\begin{align*}
...
\begin{itemize}
\item $\Pi: \chi_f \horc \looseid_{\ten}(\beta \times \beta)   \RRightarrow{} \beta \looseid_{\ten} \horc \bar{\chi}_g$
\item $M: \iota_f \horc \looseid_{I} \RRightarrow{} \beta \looseid_{I_A} \horc \bar{\iota}_g$
\end{itemize}
...
It is {\bf oplax monoidal} if it is equipped with 3-cells $\bar{\Pi}$ and $\bar{M}$ that point in the opposite direction of $\Pi$ and $M$, respectively such that analogous coherence equations hold with the 3-cells pasted together in a suitable order.
...
We call a loose 2-cell $\beta$ a {\bf strong monoidal 2-cell} when it is equipped with $M, \Pi, \bar{M}$ and $\bar{\Pi}$, which correspond to each other in pairs as mates under the adjoint equivalence structure on $\chi$ and $\iota$, or $\bar{\chi}, \bar{\iota}$, respectively.
...
\end{equation}
  ...
  Let $f,g,f',g', \alpha, \beta, \gamma$ and $\delta: g \Rightarrow g'$ be oplax monoidal 1-cells, 2-cells, and icons, respectively. An \textbf{oplax monoidal 3-cell} is a 3-cell  $\Gamma$ as depicted above, such that two equalities analogous to~\ref{eq:mon3cell1} and~\ref{eq"mon3cell2} hold, where the 3-cells are pasted together according to the direction of $\bar{M}, \bar{N}, \bar{\Pi}$, and $\bar{\Sigma}$. The 3-cell $\Gamma$ is {\bf strong monoidal} if it is lax monoidal and oplax monoidal.
...
An analogous construction makes $\transid_{\transid_A}$ into an oplax monoidal 2-cell. It follows directly from the fact that $M^{\looseid_{\transid_A}}$ and $\overline{M^{\looseid_{\transid_A}}}$ are mates under the adjoint equivalence structure on $\iota$, that the same is true for $M^{\transid_{\transid_A}}$ and $\overline{M^{\transid_{\transid_A}}}$. Likewise, $\Pi^{\transid_{\transid_A}}$ and $\overline{\Pi^{\transid_{\transid_A}}}$ are mates under the adjoint equivalence structure on $\chi$.
