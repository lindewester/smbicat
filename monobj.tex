...
\node (tt0) at (0,3) {\small $\tens(I_B \times f)i_2$};
\node (tt1) at (1,3) {\small $\tens(f I_A \times f)i_2$};
\node (tt2) at (2,3) {\small $f \tens(I_A \times \transid)i_2$};
\node (tt3) at (3,3) {\small $g \tens(I_A \times \transid)i_2$};
\node (tt4) at (4,3) {\small $g$};
...
\draw[doubleloose] (tt0) to node[above]{\small $\looseid_{\tens}(\iota_f \times \looseid_f)\looseid_{i_2}$} (tt1);
\draw[doubleloose] (tt1) to node[above]{\small $\chi (\looseid_{I \times \transid})\looseid_{i_2}$} (tt2);
\draw[doubleloose] (tt2) to node[above]{\small $\beta \looseid $} (tt3);
\draw[doubleloose] (tt3) to node[above]{\small $\looseid l$} (tt4);
...
\draw[doubletighteq] (tt0) to (t0);
\draw[doubletighteq] (tt2) to (t2);
\draw[doubletighteq] (tt4) to (t4);
...
\node at (3,2.5) {\small $\iso l_{\beta}$};
\node at (1,2.5) {\small $=$};
...
\begin{aligned}
\begin{tikzpicture}[xscale=3, yscale=1.5]
\node (tt0) at (0,3) {\small $\tens(f\times I_B)i_1$};
\node (tt1) at (1,3) {\small $\tens(f\times fI_A)i_1$};
\node (tt2) at (2,3) {\small $f \tens(\id \times I_A)i_1$};
\node (tt3) at (3,3) {\small $g \tens(\id \times I_A)i_1$};
\node (tt4) at (4,3) {\small $g$};
%%%%%%%%%%%
...
\node (b4) at (4,0) {\small $g$};
%%%%%%%%%%%%%
\draw[doubleloose] (tt0) to node[above]{$\small \looseid_{\tens}(\looseid_f \times \iota_f)\looseid_{i_1}$} (tt1);
\draw[doubleloose] (tt1) to node[above]{\small $\chi (\looseid \times \looseid_I)\looseid_{i_1}$} (tt2);
\draw[doubleloose] (tt2) to node[above]{\small $\beta \looseid$} (tt3);
\draw[doubleloose] (tt3) to node[above]{\small $\looseid_g r$} (tt4);
%%%%%%%%%%
