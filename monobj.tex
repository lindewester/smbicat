...
%\begin{lem}
%Monoidal objects, 1-cells, 2-cells, icons and 3-cells in the locally cubical bicategory $\cBicat$ correspond to monoidal bicategories, monoidal pseudo functors, monoidal pseudo transformations, monoidal icons and monoidal cubical transformations
%\end{lem}
