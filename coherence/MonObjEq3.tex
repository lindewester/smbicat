...
\node (A5) at (4.5,7){$\substack{\tens (\transid \times \tens) \\ ( \transid \times \tens \times \transid) \\ (\transid \times (\transid  \times I)i_1 \times \transid)}$};
\node (A7) at (6,7){$\substack{\tens (\transid \times \tens)\\(\transid \times \transid \times \tens)\\ (\transid \times \transid  \times (I \times \transid)i_2)}$};
...
\node (B3) at (3,6){$\substack{\tens (\tens \times \transid) \\ (\transid \times \tens \times \transid) \\ (\transid \times (\transid \times I)i_1 \times \transid)}$};
\node (B5) at (4.5,6){$\substack{\tens (\transid \times \tens) \\ ( \transid \times \tens \times \transid) \\ (\transid \times (\transid  \times I)i_1 \times \transid)}$};
...
\node (C15) at (.9,5){$\substack{\tens (\tens \times \transid) \\((\transid \times I)i_1 \times \transid) \\(\tens \times \transid \times \transid)}$};
\node (C2) at (1.9,5){$\substack{\tens (\tens \times \transid) \\(\tens \times \transid \times \transid) \\(\transid \times \transid \times (I \times \transid)i_2) \\}$};
\node (C3) at (3,5){$\substack{\tens (\tens \times \transid) \\ (\transid \times \tens \times \transid) \\ (\transid \times (\transid \times I)i_1 \times \transid)}$};
\node (C5) at (4.5,5){$\substack{\tens (\transid \times \tens) \\ ( \transid \times \tens \times \transid) \\ (\transid \times (\transid  \times I)i1 \times \transid)}$};
\node (C7) at (6,5){$\substack{\tens (\transid \times \tens)\\(\transid \times \transid \times \tens)\\ (\transid \times \transid  \times (I \times \transid)i_2)}$};
...
\node (D15) at (.9,4){$\substack{\tens (\tens \times \transid) \\((\transid \times I)i_1 \times \transid) \\(\tens \times \transid \times \transid)}$};
\node (D2) at (1.9,4){$\substack{\tens (\tens \times \transid) \\(\tens \times \transid \times \transid) \\(\transid \times \transid \times (I \times \transid)i_2) \\}$};
\node (D3) at (3,4){$\substack{\tens (\transid \times \tens) \\ (\tens \times \transid \times  \transid) \\ (\transid \times \transid \times (I \times \transid)i_2)}$};
\node (D5) at (4.5,4){$\substack{\tens (\tens \times \transid) \\ (\transid \times \transid \times \tens) \\ (\transid \times \transid \times (I \times \transid)i_2)}$};
\node (D7) at (6,4){$\substack{\tens (\transid \times \tens) \\ (\transid \times \transid \times \tens) \\ (\transid \times \transid \times (I \times \transid)i_2)}$};
...
\node (E15) at (.9,3){$\substack{\tens (\tens \times \transid) \\((\transid \times I)i_1 \times \transid) \\(\tens \times \transid \times \transid)}$};
\node (E2) at (1.9,3){$\substack{\tens (\tens \times \transid) \\(\tens \times \transid \times \transid) \\(\transid \times \transid \times (I \times \transid)i_2) \\}$};
\node (E3) at (3,3){$\substack{\tens (\transid \times \tens) \\ (\tens \times \transid \times  \transid) \\ (\transid \times \transid \times (I \times \transid)i_2)}$};
...
\node (A5) at (4,7){$\substack{\tens (\transid \times \tens) \\ ( \transid \times \tens \times \transid) \\ (\transid \times (\transid  \times I )i_1\times \transid)}$};
\node (A7) at (6,7){$\substack{\tens (\transid \times \tens)\\(\transid \times \transid \times \tens)\\ (\transid \times \transid  \times (I \times \transid)i_2)}$};
\node (A8) at (7,7){$\substack{\tens (\transid \times \tens)}$};
%%%
\draw[doubleloose] (A1) to node[above]{$\substack{\alpha }$} (A3);
