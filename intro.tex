...
Then in \S\ref{sec:constr-symm-mono} we specialize this to the functor from fibrant double categories to bicategories, yielding functorial constructions of monoidal, braided, and symmetric monoidal bicategories.
