...
\begin{eg}
When we take the category $AB$ of Abelian groups and group homomorphisms as our symmetric monoidal category, we obtain the double category $\cMod$ of rings, ring homomorphisms, bimodules and bimodule homomorphisms. As a consequence of Lemma's ~\ref{thm:sym11-symbi}, ~\ref{lem:algdouble}, ~\ref{lem:algsymmon}, and ~\ref{lem:algfib}, the horizontal bicategory $\cMod$ of $\lMod$ is a symmetric monoidal.
\end{eg}
