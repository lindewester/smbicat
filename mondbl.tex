...
Alternatively, we can draw the poincar\'{e} dual of the diagram ~\cite{myers2016string}. In these ``string diagrams'', the regions are objects, the vertical lines are 1-cells, the horizontal lines are 1-morphisms and the box is a 2-morphism. Below we depict loose and tight composition of 2-cells.
...
\fxnote[author=MS]{At this point in the paper we haven't introduced monoidal structure, so this comment doesn't seem quite right here.}
\fxnote[author=LW]{Fixed. The monoidal structure was not relevant for the way we use them.}
...
We write \cDbl\ for the strict 2-category of double categories, functors, and
...
\begin{rmk}
  ...
  and inherit their monoidal structure in this way.\fxnote{There were some recent preprint(s) on the arxiv about this; cite them.}\fxnote[author=MS]{I no longer know what I had in mind when I wrote that (I'm assuming I was the one who wrote it).}
\end{rmk}
