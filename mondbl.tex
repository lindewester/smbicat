...
\fxnote[author=LW]{We need to decide if we want to keep this (here)}
...
\fxnote[author=LW]{We should combine this with the example in the last section, or mention that the last section provides details.}
\begin{eg}
